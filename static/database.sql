...
CREATE TABLE IF NOT EXISTS `images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=192 DEFAULT CHARSET=utf8 COMMENT='locations and descriptions of images used on the site\r\n';

-- Dumping data for table nzvr_db.images: ~163 rows (approximately)
DELETE FROM `images`;
/*!40000 ALTER TABLE `images` DISABLE KEYS */;
INSERT INTO `images` (`id`, `title`, `filename`, `type`, `type_id`, `is_schematic`, `rank`, `attribution`) VALUES
	(1, 'Clipper 5M4 Front', 'clipper_5m4_front.jpg', 1, 1, 0, 12, NULL),
	(2, 'Clipper 5M4 Side', 'clipper_5m4_lside.jpg', 1, 1, 0, 13, NULL),
	(3, 'Clipper 5M4 Dial', 'clipper_5m4_dial.jpg', 1, 1, 0, 14, NULL),
	(4, 'Clipper 5M4 Rear', 'clipper_5m4_rear.jpg', 1, 1, 0, 15, NULL),
	(5, 'Clipper 5M4 Rear 2', 'clipper_5m4_rear_label.jpg', 1, 1, 0, 20, NULL),
	(7, 'Clipper 5M4 Schematic (early)', 'clipper_5m4_schematic.png', 1, 1, 1, 30, NULL),
	(8, 'Clipper 5M4 Label', 'clipper_5m4_label.png', 1, 1, 0, 29, NULL),
	(9, 'Clipper 5M4 Red', 'clipper_5m4_red.jpg', 1, 1, 0, 4, NULL),
	(10, 'Clipper 5M4 Blue', 'clipper_5m4_blue.jpg', 1, 1, 0, 3, NULL),
	(11, 'Clipper 5M4 Green', 'clipper_5m4_green.jpg', 1, 1, 0, 2, NULL),
	(12, 'Clipper 5M4 Brown', 'clipper_5m4_brown.jpg', 1, 1, 0, 5, NULL),
	(13, 'Clipper 5M4 Ivory', 'clipper_5m4_ivory.jpg', 1, 1, 0, 1, NULL),
	(14, 'Clipper 5M4 Black (RARE)', 'clipper_5m4_black.jpg', 1, 1, 0, 6, NULL),
	...
	(165, 'Columbus 75', '506972638.jpg', 1, 23, 0, 99, NULL),
	(166, 'Columbus 75', '506972652.jpg', 1, 23, 0, 99, NULL),
	(167, 'Columbus 75', 'victory.jpg', 1, 23, 0, 99, NULL),
	...
	(187, 'Clipper 5M4', '5m4oldnewbottom.jpg', 1, 1, 0, 99, NULL),
	(188, 'Clipper 5M4', '5m4oldnewtop.jpg', 1, 1, 0, 99, NULL),
...
CREATE TABLE IF NOT EXISTS `model` (
  ...
  `same_chassis` text COMMENT 'models using same chassis',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8;

-- Dumping data for table nzvr_db.model: ~25 rows (approximately)
DELETE FROM `model`;
/*!40000 ALTER TABLE `model` DISABLE KEYS */;
INSERT INTO `model` (`id`, `variant`, `code`, `brand_id`, `start_year`, `start_year_approx`, `end_year`, `end_year_approx`, `num_valves`, `valve_lineup`, `bands`, `notes`, `if`, `same_chassis`) VALUES
	...
	(11, NULL, 'OA', 12, NULL, 0, NULL, 0, 5, 'ECH81, EF89, EBC81, EL84, EZ80', 2, '<p>The Fountain model O.A. is a dual-band set with a formica finish, and appears to be based on the <a href="/colt">Bell Colt</a> World-Wave chassis minus the tone control</p>', 'Most likely 455kc/s', NULL),
	...
	(13, NULL, '12', 2, '1940', 1, NULL, 0, 5, '6K8G, 6K7G, 6B8G, 6K6G, 84', 1, '<p>The tiny Model 12, mains and AC/DC operation with modifications (see service bulletin images)</p><p>Also released as the <a href="/model/courtenay/12">Courtenay \'Tiki\'</a></p>', '455kc/s', '14'),
	(14, NULL, '12', 1, '1940', 1, NULL, 0, 5, '6K8G, 6K7G, 6B8G, 6K6G, 84', 1, '<p>The tiny Model 12, known as the Courtenay \'Tiki\'.  Mains and AC/DC operation with modifications (see service bulletin images)</p><p>Also released as the <a href="/model/columbus/12">Columbus model 12</p>', '455kc/s', '13'),
	...
	(17, NULL, '84', 2, '1938', 0, NULL, 0, 5, '6A8, 6K7, 6B7, 42, 80 (and 6E5 magic eye on some models)', 1, '<p>5-valve + 6E5 magic eye, Courtenay version as well which was sighted without the magic eye', '456kc/s', NULL),
	(18, NULL, '84', 1, '1938', 0, NULL, 0, 5, '6A8, 6K7, 6B7, 42, 80 (and 6E5 magic eye on some models)', 1, '<p>5-valve + 6E5 magic eye, Columbus version as well', '456kc/s', NULL),
