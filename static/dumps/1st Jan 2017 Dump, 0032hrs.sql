...
CREATE TABLE IF NOT EXISTS `images` (
  ...
  `thumb` varchar(100) NOT NULL COMMENT 'path to the thumbnail',
...
-- Dumping data for table nzvr_db.images: ~19 rows (approximately)
DELETE FROM `images`;
/*!40000 ALTER TABLE `images` DISABLE KEYS */;
INSERT INTO `images` (`id`, `name`, `path`, `thumb`, `type`, `type_id`, `is_schematic`, `rank`) VALUES
	...
	(15, 'Pacific Raleigh Dual Wave', '/model/pacific/6 valve dual wave/raleigh/20160320_144502.jpg', '/model/pacific/6 valve dual wave/raleigh/20160320_144502.tn.jpg', 1, 2, b'0', 2),
	(16, 'Pacific Raleigh Dual Wave Dial', '/model/pacific/6 valve dual wave/raleigh/20160322_104320.jpg', '/model/pacific/6 valve dual wave/raleigh/20160322_104320.tn.jpg', 1, 2, b'0', 3),
	(17, 'Pacific Raleigh Dual Wave Valve Card', '/model/pacific/6 valve dual wave/raleigh/20160322_104136.jpg', '/model/pacific/6 valve dual wave/raleigh/20160322_104136.tn.jpg', 1, 2, b'0', 4),
	(18, 'Pacific Raleigh Dual Wave Front', '/model/pacific/6 valve dual wave/raleigh/20160322_104306.jpg', '/model/pacific/6 valve dual wave/raleigh/20160322_104306.tn.jpg', 1, 2, b'0', 1),
	(19, 'Pacific Raleigh Dual Wave Advert', '/model/pacific/6 valve dual wave/raleigh/Pacific Raleigh 6-valve advert.png', '/model/pacific/6 valve dual wave/raleigh/Pacific Raleigh 6-valve advert.tn.png', 1, 2, b'0', 5),
	(20, 'Pacific 6 Valve Dual Wave Schematic', '/model/pacific/6 valve dual wave/raleigh/Pacific 6-Valve Dual-Wave Schematic.png', '/model/pacific/6 valve dual wave/raleigh/Pacific 6-Valve Dual-Wave Schematic.tn.png', 1, 2, b'1', 30),
	(21, 'Pacific Elite', '/model/pacific/6 valve dual wave/elite/elite.jpg', '/model/pacific/6 valve dual wave/elite/elite.tn.jpg', 1, 3, b'0', 1);
...
INSERT INTO `model` (`id`, `name`, `number`, `start_year`, `start_year_approx`, `end_year`, `end_year_approx`, `num_valves`, `valve_lineup`, `bands`, `brand_id`, `notes`) VALUES
	...
	(2, 'Raleigh', '6 Valve Dual Wave', '1934', 0, '1935', 0, 6, '6D6, 6A7, 6D6, 6B7, 42, 80', NULL, 3, '<p>Art deco tabletop radio from 1934</p>'),
	(3, 'Elite', '6 Valve Dual Wave', '1934', 0, '1935', 0, 6, '6D6, 6A7, 6D6, 6B7, 42, 80', NULL, 3, '<p>Stunning art deco console from 1934</p>');
