...
CREATE TABLE IF NOT EXISTS `images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='locations and descriptions of images used on the site\r\n';

-- Dumping data for table nzvr_db.images: ~6 rows (approximately)
DELETE FROM `images`;
/*!40000 ALTER TABLE `images` DISABLE KEYS */;
INSERT INTO `images` (`id`, `name`, `path`, `type`, `type_id`, `is_schematic`) VALUES
	(1, 'Clipper 5M4 Front', '/model/clipper/5m4/clipper_5m4_front.jpg', 1, 1, b'0'),
	(2, 'Clipper 5M4 Side', '/model/clipper/5m4/clipper_5m4_lside.jpg', 1, 1, b'0'),
	(3, 'Clipper 5M4 Side', '/model/clipper/5m4/clipper_5m4_rside.jpg', 1, 1, b'0'),
	(4, 'Clipper 5M4 Dial', '/model/clipper/5m4/clipper_5m4_dial.jpg', 1, 1, b'0'),
	(5, 'Clipper 5M4 Rear', '/model/clipper/5m4/clipper_5m4_rear.jpg', 1, 1, b'0'),
	(6, 'Clipper 5M4 Rear 2', '/model/clipper/5m4/clipper_5m4_rear_label.jpg', 1, 1, b'0');
