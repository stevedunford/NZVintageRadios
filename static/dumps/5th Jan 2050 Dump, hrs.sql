...
-- Dumping data for table nzvr_db.brand: ~12 rows (approximately)
DELETE FROM `brand`;
...
CREATE TABLE IF NOT EXISTS `images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=120 DEFAULT CHARSET=utf8 COMMENT='locations and descriptions of images used on the site\r\n';

-- Dumping data for table nzvr_db.images: ~90 rows (approximately)
DELETE FROM `images`;
...
CREATE TABLE IF NOT EXISTS `model` (
  ...
  `if` varchar(50) DEFAULT NULL COMMENT 'IF transformer peak freq.',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;

-- Dumping data for table nzvr_db.model: ~12 rows (approximately)
DELETE FROM `model`;
/*!40000 ALTER TABLE `model` DISABLE KEYS */;
INSERT INTO `model` (`id`, `variant`, `code`, `brand_id`, `start_year`, `start_year_approx`, `end_year`, `end_year_approx`, `num_valves`, `valve_lineup`, `bands`, `notes`, `if`) VALUES
	...
	(2, 'Raleigh', '6 Valve Dual Wave', 3, '1934', 0, NULL, 0, 6, '6D6, 6A7, 6D6, 6B7, 42, 80', 2, '<p>Art deco tabletop radio from 1934</p>', '256kc/s'),
	(3, 'Elite', '6 Valve Dual Wave', 3, '1934', 0, NULL, 0, 6, '6D6, 6A7, 6D6, 6B7, 42, 80', 2, '<p>Stunning art deco console from 1934</p>', '256kc/s'),
	...
	(11, NULL, 'O.A.', 12, NULL, 0, NULL, 0, 5, 'ECH81, EF89, EBC81, EL84, EZ80', 2, '<p>Formica finish, appears to be based on the <a href="/colt">Bell Colt</a> World-Wave chassis minus the tone control</p>', 'Most likely 455kc/s'),
