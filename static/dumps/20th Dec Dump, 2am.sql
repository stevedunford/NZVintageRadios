...
INSERT INTO `brand` (`id`, `name`, `alias`, `tagline`, `manufacturer_id`, `distributor_id`, `year_started`, `started_approx`, `year_ended`, `ended_approx`, `notes`) VALUES
	...
	(3, 'Pacific', 'pacific', 'In A Sphere Of Its Own', 3, 3, '1933', 0, '1937', 1, '<p>Pacific sets were built initially as special runs for Pacific Radio Co. Ltd by Radio Corp. N.Z. and then as standard RCNZ chassis models from around 1935/36.</p><p>Pacific sets from the early-mid 30\'s were known for their art-deco styling - in particular the 1934/35 \'Elite\' console, which is considered very rare and the envy of most collectors.</p><table><tbody><tr><td><img class="inline_image" src="/static/images/models/pacific/elite1.jpg" alt="Pacific Elite Console 1934/35" /></td></tr><tr><td>The world-famous \'Elite\' console</td></tr></tbody></table><p> </p>'),
...
-- Dumping data for table nzvr_db.distributor: ~3 rows (approximately)
DELETE FROM `distributor`;
/*!40000 ALTER TABLE `distributor` DISABLE KEYS */;
INSERT INTO `distributor` (`id`, `name`, `alias`, `address`, `notes`, `logo`) VALUES
...
-- Dumping data for table nzvr_db.manufacturer: ~4 rows (approximately)
DELETE FROM `manufacturer`;
/*!40000 ALTER TABLE `manufacturer` DISABLE KEYS */;
INSERT INTO `manufacturer` (`id`, `name`, `alias`, `address`, `year_started`, `year_started_approx`, `year_ended`, `year_ended_approx`, `notes`, `logo`) VALUES
