...
-- Dumping data for table nzvr_db.images: ~94 rows (approximately)
DELETE FROM `images`;
...
-- Dumping data for table nzvr_db.model: ~4 rows (approximately)
DELETE FROM `model`;
